...
if strcmp(mappingtype,'u2') %Uniform 2
  ...
  for i = 0:2^samples-1
    ...
    j = bitset(bitshift(i,1,'uint8'),1,bitget(i,samples)); % - rotate left
        % - Changed bithshift code to assume time of uint8 rather than 
        % setting the number of bits to 8 (same effect I guess?)
        % This is due to deprecation of bitshift(A,k,N)
